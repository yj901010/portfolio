  ...
  return (
    <section className="relative aspect-[16/7] w-full overflow-hidden" id="home">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-10 pt-28 pb-10">
        <h1 className="mt-1 text-3xl sm:text-5xl font-extrabold text-white drop-shadow">{item.title}</h1>
        {item.subtitle && <p className="mt-3 text-white/90 max-w-3xl text-lg sm:text-xl">{item.subtitle}</p>}
        {item.description && (
